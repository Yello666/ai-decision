...
from .own_hotspot import router as own_hotspot_router
from .pricing_analyze import router as pricing_agent_router
from .products import router as products_router
from .local_products import router as local_products_router
...
router.include_router(own_hotspot_router)
router.include_router(pricing_agent_router)
router.include_router(products_router)
router.include_router(local_products_router)
