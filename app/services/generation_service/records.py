...
#
#     try:
#         data = await legacy_client.start_video_generation(
#             prompt_used,
#             model=model,
...
#         return
#     try:
#         data = await legacy_client.get_video_status(gen.external_id)
...
#
#     try:
#         data = await legacy_client.start_image_generation(
#             prompt_used,
#             model=model,
#             resolution=resolution,
#             aspect_ratio=aspect_ratio,
