...
class ProductSelectObject(Base):
    ...
    opportunity_score = Column(DECIMAL(6, 2), nullable=True, index=True)
    opportunity_score_level = Column(String(32), nullable=True, index=True)
    opportunity_score_reason = Column(Text, nullable=True)
...
class ProductSelectMatch(Base):
    ...
    selection_order = Column(Integer, nullable=True, index=True)
    selection_role = Column(String(64), nullable=True, index=True)
    selection_score = Column(DECIMAL(6, 2), nullable=True)
    visual_similarity_score = Column(DECIMAL(6, 2), nullable=True)
    keyword_similarity_score = Column(DECIMAL(6, 2), nullable=True)
    final_similarity_score = Column(DECIMAL(6, 2), nullable=True, index=True)
    similarity_level = Column(String(32), nullable=True, index=True)
    is_reference_used = Column(Boolean, nullable=False, default=False, index=True)
...
class ProductSelectObjectProfile(Base):
    ...
    confidence_score = Column(DECIMAL(6, 2), nullable=True)
    estimate_detail_json = Column(JSON, nullable=True)
    is_active = Column(Boolean, nullable=False, default=True, index=True)
    created_at = Column(DateTime(timezone=True), nullable=False, server_default=func.now())
    updated_at = Column(DateTime(timezone=True), nullable=False, server_default=func.now(), onupdate=func.now())
