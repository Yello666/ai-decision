...
CREATE TABLE IF NOT EXISTS generations (
  ...
  type VARCHAR(16) NOT NULL COMMENT '任务类型：video | image | text',
  ...
  result_url TEXT NULL COMMENT '结果资源 URL（视频/图片）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='内容生成任务表：视频/图片/文字生成及轮询';
